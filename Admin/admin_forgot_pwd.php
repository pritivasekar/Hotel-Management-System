		...
		<form method="post" action="admin_forgot_pwd1.php">
			<table>
				...
				<tr>
					...
					<td><input class="input" type="text" name="adminid" placeholder="Enter username" required></td>
				</tr>
				<tr>
					<td>Enter Email:</td>
					<td><input class="input" type="text" name="empid" placeholder="Enter Email" required></td>
				</tr>
				<tr><td><br></td></tr>
				<tr>
